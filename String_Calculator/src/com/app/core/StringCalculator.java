...
public class StringCalculator {
    ...
    //5. add with a negative number - throws exception
    ...
    //2. add method to handle unknown amount of number 
    ...
    private String printInteger() {
        ...
        //6, number bigger than 1000 shoule be ignored
        //7. delimiter can be of any length
        //8. allow multiple delimiter
        //9. mul delimiter with length longer than 1 char
}
}